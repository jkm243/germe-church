        ...
        <div className="py-20">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center p-8 border border-gray-100">
              ...
              <p className="text-2xl font-light text-vivid-green-600 mb-4">10h00</p>
            ...
            <div className="text-center p-8 border border-gray-100">
              ...
              <p className="text-2xl font-light text-vivid-green-600 mb-4">19h00</p>
            ...
            <div className="text-center p-8 border border-gray-100">
              ...
              <p className="text-2xl font-light text-vivid-green-600 mb-4">18h00</p>
